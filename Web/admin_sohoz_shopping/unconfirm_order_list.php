        ...
        <link rel="stylesheet" href="admin_design.css">
         <script>
            function confirm_delete(){
                return confirm("Are you completed this order?")
            }
        </script>
    </head>
    ...
    <body>
        ...
        <table class="product_list">
           ...
           <?php
            ...
            $i = 0;
            $statement = $db->prepare("SELECT * FROM customer_shopping WHERE confirm = 0");
            $statement->execute();
            ...
            <tr>
                ...
                <td> <a class="edit" onclick="return confirm_delete();"  href="complete.php?id=<?php echo $row['id']; ?>">Confirm</td>
            </tr>
            <?php
                }
            }
